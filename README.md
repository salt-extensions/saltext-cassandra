...
The saltext-cassandra project team welcomes contributions from the community.
...
```bash
# Clone the repo
git clone --origin salt git@github.com:salt-extensions/saltext-cassandra.git

# Change to the repo dir
cd saltext-cassandra

# Create a new venv
python3 -m venv env --prompt saltext-cassandra
